...
open class VariableBlurUIView: UIVisualEffectView {
  ...
  private func makeGradientImage(width: CGFloat = 100, height: CGFloat = 400, startOffset: CGFloat, direction: VariableBlurDirection) -> CGImage {
    ...
    case .blurredBottomClearTop:
      ...
      ciGradientFilter.point1 = CGPoint(x: 0, y: height - startOffset * height)
    case .blurredLeftClearRight:
      ciGradientFilter.point0 = CGPoint(x: 0, y: 0)
